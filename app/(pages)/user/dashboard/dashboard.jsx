...
//     setData([
//       ...Data,
//       { id: Data.length + 1, name: shopName, description: shopDescription, location: shopLocation }
//     ]);
...
//     const shopToEdit = Data.find(shop => shop.id === id);
...
//       <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">My Data Dashboard</h1>
